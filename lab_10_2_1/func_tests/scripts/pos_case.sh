...
cd ../../
$cmd < ./func_tests/data/$1 1> ./func_tests/scripts/file_stream_out.txt 2> ./func_tests/scripts/error.txt
./func_tests/scripts/comparator.sh ./func_tests/scripts/file_stream_out.txt ./func_tests/data/$2
code_return=$?
